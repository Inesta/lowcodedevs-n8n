...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./logger-proxy", "./node-helpers", "./observable-object", "./telemetry-helpers", "./errors", "./constants", "./common", "./cron", "./data-table.types", "./deferred-promise", "./execution-context", "./execution-context-establishment-hooks", "./safe-regex", "./global-state", "./interfaces", "./run-execution-data-factory", "./message-event-bus", "./execution-status", "./expression", "./expressions/expression-helpers", "./from-ai-parse-utils", "./node-helpers", "./tool-helpers", "./node-reference-parser-utils", "./metadata-utils", "./workflow", "./workflow-data-proxy", "./workflow-data-proxy-env-provider", "./versioned-node-type", "./type-validation", "./result", "./schemas", "./run-execution-data/run-execution-data", "./utils", "./type-guards", "./graph/graph-utils", "./extensions", "./extensions/expression-parser", "./native-methods", "./node-parameters/filter-parameter", "./node-parameters/parameter-type-validation", "./node-parameters/path-utils", "./evaluation-helpers", "./workflow-diff"], factory);
    }
