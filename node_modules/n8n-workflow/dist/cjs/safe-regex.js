...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./logger-proxy"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.safeRegex = void 0;
    exports.parseRegexLiteral = parseRegexLiteral;
    exports.setSafeRegexEngine = setSafeRegexEngine;
    exports.resetSafeRegexEngine = resetSafeRegexEngine;
    ...
    function parseRegexLiteral(value) {
        ...
        if (!match)
            return { source: literal, flags: '' };
        return { source: match[1] ?? '', flags: match[2] ?? '' };
    }
    function globalFlag(flags) {
    ...
    function nativeEngine() {
        ...
        return {
            ...
            replace: (pattern, input, flags, replacement) => input.replace(new RegExp(pattern, flags), replacement),
            matchAll: (pattern, input, flags) => Array.from(input.matchAll(new RegExp(pattern, globalFlag(flags)))),
            split: (pattern, input, flags) => input.split(new RegExp(pattern, flags)),
        };
    }
    function nodeVmEngine(vm) {
        const context = {
            flags: '',
            input: '',
            pattern: '',
        ...
        function run(script) {
            try {
                ...
                if (isTimeout(error))
                    throw new Error(REGEX_TIMEOUT_ERROR_MESSAGE);
                throw error;
            }
        }
        return {
    ...
    function setSafeRegexEngine(regexEngine) {
        engine = regexEngine;
    }
    function resetSafeRegexEngine() {
    ...
    exports.safeRegex = {
        ...
        replace: (pattern, input, flags, replacement) => engine.replace(pattern, input, flags, replacement),
