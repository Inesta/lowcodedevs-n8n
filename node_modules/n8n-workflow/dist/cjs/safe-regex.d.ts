...
export declare function parseRegexLiteral(value: string): RegexLiteral;
export declare function setSafeRegexEngine(regexEngine: RegexEngine): void;
export declare function resetSafeRegexEngine(): void;
export declare const safeRegex: RegexEngine;
